  ...
  <n-drawer v-model:show="showOuter" :width="500">
    ...
    >   
      <n-form-item label="First Name" path="first_name" class="pt-0">
        <n-input type="text" min-length="2" placeholder="Enter Name" clearable v-model:value.trim="formValue.first_name" />
        </n-form-item>
        <n-form-item label="Last Name" path="last_name" class="pt-0">
        <n-input type="text" min-length="2" placeholder="Enter Name" clearable v-model:value.trim="formValue.last_name" />
        </n-form-item>
       
        <n-form-item label="Cell" path="cell_phone">
        <masked-input mask="(###) ###-####"  placeholder="Enter Cell Phone" clearable v-model:value="formValue.cell_phone" />
        </n-form-item>
        <n-form-item label="Office" path="office_phone">
        <masked-input mask="(###) ###-####"  placeholder="Enter Office Phone" clearable v-model:value="formValue.office_phone" />
        </n-form-item>
        ...
        <n-form-item  label="Position" path="job_title" >
          <n-input type="text" min-length="2" placeholder="Enter Job Title" clearable v-model:value.trim="formValue.job_title" /> 
        </n-form-item>
    </n-form>
      <template #footer>
