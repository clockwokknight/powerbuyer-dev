...
<template>
  <div class="__custom-input">
    <label
      v-if="type !== 'header'"
      class="text-gray-600 bg-white text-xs translate-x-4 translate-y-[-8px] px-2 tracking-widest uppercase font-bold z-40"
      >{{ label || "label" }}
    </label>
    ...
    <div
      ...
      @mouseover="
        () => {
          hoverInput = true;
          caretX = editing ? '0px' : '24px';
        }
      "
      @mouseleave="
        () => {
          hoverInput = false;
          caretX = editing ? '0px' : '48px';
        }
      "
    >
      <div
      ...
      >
        ...
        <div
          ...
          :class="`
                ...
                ${
                  hoverInput || editing || type === 'header'
                    ? '!opacity-100'
                    : 'opacity-0'
                }
            `"
